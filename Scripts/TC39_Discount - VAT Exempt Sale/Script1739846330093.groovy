...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - VAT EXEMPT SALE'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Name'), 'Juan Dela Cruz', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Address'), '123 Espana Blvd.', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - TIN'), '6232109373291', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Business Style'), 'Sample Business', 0)
