...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Per Piece'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.EditText - 0.00'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - 1'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - 1'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - 0'), 0)
