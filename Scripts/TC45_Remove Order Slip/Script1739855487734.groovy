...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - ADD ORDER SLIP'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (9)'), 'Echo', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - SUBMIT'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - REMOVE ORDER SLIP'), 0)
