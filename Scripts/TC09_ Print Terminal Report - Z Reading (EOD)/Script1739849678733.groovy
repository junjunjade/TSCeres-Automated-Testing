...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - POS READING'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - EOD (Z Reading)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - PRINT'), 0)
