...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText'), 'Chicken', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.CheckBox - Selling'), 0)
