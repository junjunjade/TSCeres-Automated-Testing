...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Ingredients'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - ADD (5)'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (11)'), 'Sample Ingredient', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.EditText (12)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Small'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.EditText (13)'), 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - Save (8)'), 0)
