...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Half-morning shift'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - DELETE (1)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - DELETE (2)'), 0)
