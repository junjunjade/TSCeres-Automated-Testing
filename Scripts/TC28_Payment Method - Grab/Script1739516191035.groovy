...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - GRAB'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText'), '435432983405', 0)
