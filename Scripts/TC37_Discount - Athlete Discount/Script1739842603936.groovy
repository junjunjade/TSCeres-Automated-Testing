...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - ATHLETE DISCOUNT'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Name'), 'Lebron James', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - ID No'), 'B-01-12345-2', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - TIN'), '5149856544782', 0)
