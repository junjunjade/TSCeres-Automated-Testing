...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - DELIVERY'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - DELIVERY'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - In-house'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Juan S. Dela Cruz'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - SELECT'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Rider'), 'Echo Nolasco', 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - PASTA'), 0)
