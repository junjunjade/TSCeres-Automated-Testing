...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Unit of Measure'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - ADD (6)'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (14)'), 'PP', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText'), 'Per Pack', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - SAVE (9)'), 0)
