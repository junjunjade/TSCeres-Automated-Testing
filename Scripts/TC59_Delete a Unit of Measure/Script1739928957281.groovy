...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Per Pack'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - DELETE (4)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - DELETE (5)'), 0)
