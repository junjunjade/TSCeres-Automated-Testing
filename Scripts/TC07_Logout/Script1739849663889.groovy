...
Mobile.startApplication('C:\\Users\\Ritch\\Desktop\\ANDROID TESTING\\Echo\\TSCeres 2025\\16.0.0.0.40.91.apk', true)
...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - LOG OUT (1)'), 0)

Mobile.delay(5)  // Wait for 5 seconds
