...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - SUSPEND TRANSACTION'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - OKAY'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - RESUME SUSPENDED TRANSACTION'), 0)
