...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Sample Ingredient'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - DELETE (3)'), 0)
