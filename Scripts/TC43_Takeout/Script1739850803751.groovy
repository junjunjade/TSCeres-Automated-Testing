...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - TAKE-OUT'), 0)
...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText'), '4568487450235', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText'), 'Juan Dela', 0)
