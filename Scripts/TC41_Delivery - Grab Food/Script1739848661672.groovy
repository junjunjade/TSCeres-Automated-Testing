...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Grab Food'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText'), '123456789', 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - SUBMIT (2)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - BLACK COFFEE'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Item Value'), '120', 0)
