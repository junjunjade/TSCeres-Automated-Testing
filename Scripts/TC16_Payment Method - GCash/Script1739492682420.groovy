...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - GCASH'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (4)'), '1001741938227', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (5)'), 'Gericho Nolasco', 0)
