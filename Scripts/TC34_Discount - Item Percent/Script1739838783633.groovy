...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Carbonara'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - ITEM PERCENT'), 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - 9'), 0)
