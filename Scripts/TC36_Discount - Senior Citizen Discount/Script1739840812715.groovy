...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - SC DISCOUNT'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - Name'), 'Juan Dela Cruz', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - ID No'), '1074', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText - TIN'), '4501283447362', 0)
