...
Mobile.tap(findTestObject('Object Repository/android.widget.Button - VISA DEBIT'), 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText'), '653844217985627', 0)

Mobile.setText(findTestObject('Object Repository/android.widget.EditText'), 'Junjun', 0)
